...
export const programData: Record<string, ProgramContent> = {
  boys: {
    ...
    testimonials: [
      ...
      { quote: "BTB doesn't just coach; they develop. The attention to detail means my son gets corrected on every rep. He's a completely different player after two seasons.", name: "James R.", role: "Parent · 2028 Black Team", initials: "JR" },

  ...
  return gradYears.flatMap((year) => [
    {
      ...
      steps: [
        { id: `boys-film-${year}-1`, stepNumber: 1, title: "Introduction to Film Study", type: "reading", content: { description: "Why film study matters and how structured review accelerates your development. Read through the guide and mark complete when ready." } },
        ...
        { id: `boys-film-${year}-6`, stepNumber: 6, title: "Week 3: Cuse Motion Offense", type: "film", content: { videoUrl: "https://www.youtube.com/watch?v=A5yqjZhRmTw", description: "POWLAX breaks down the Cuse motion offense from start to finish. Watch the spacing, ball movement, and off-ball reactions — could you make the next read?", duration: 5 } },
        { id: `boys-film-${year}-7`, stepNumber: 7, title: "Self-Scouting Report", type: "reading", content: { description: "Write a self-scouting report based on 3 weeks of film. Identify your top 2 strengths and top 2 areas for improvement. Keep it in your training log." } },
  ...
  return gradYears.flatMap((year) => [
    {
      ...
      description: "Weekly film breakdown sessions. Watch, analyze, and learn from game footage with guided coaching points.",
      steps: [
        { id: `girls-film-${year}-1`, stepNumber: 1, title: "Introduction to Film Study", type: "reading", content: { description: "Why film study matters and how structured review accelerates your development. Read through the guide and mark complete when ready." } },
        ...
        { id: `girls-film-${year}-7`, stepNumber: 7, title: "Self-Scouting Report", type: "reading", content: { description: "Write a self-scouting report based on 3 weeks of film. Identify your top 2 strengths and top 2 areas for improvement. Keep it in your training log." } },

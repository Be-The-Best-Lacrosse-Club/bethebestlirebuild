...
The Connection Phase (Weeks 4-6) is about putting the pieces together. Players have their individual fundamentals — now you're connecting them to team concepts. How does this individual defensive footwork connect to our slide package? How does this attacker's catch-and-throw quality connect to our offensive flow? Connection Phase drills involve more decision-making, more small-sided live play, and more emphasis on reading the defense and offense around you. Coaching points shift toward awareness: "see the whole field," "communicate before you slide," "attack the man, not the play."

Expansion Phase (Weeks 7-10) takes your team into new territory — uneven situations, zone concepts, aggressive riding, and more complex game situations. Practices have higher tempo, more competitive live reps, and more game-like pressure. This is where you're sharpening the edge. Execution Phase (Weeks 11-16) is game-prep mode: you run your stuff at full speed, you simplify to what you do best, and you use film and competition to tighten the details. Less teaching, more reinforcing, more competing.`,
        questions: [
          {
            question: "What is the primary focus of the Foundation Phase (Weeks 1-3)?",
            options: [

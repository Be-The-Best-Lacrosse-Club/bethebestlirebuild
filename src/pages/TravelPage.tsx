    ...
    <div className="min-h-screen bg-black text-white" style={{ fontFamily: "'Montserrat', sans-serif" }}>
      ...
      <section className="relative pt-24 pb-20 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[900px] mx-auto pt-16">
          <div className="text-[1.15rem] font-bold uppercase tracking-[4px] text-[var(--btb-red)] mb-6">{label} Travel Teams</div>
      ...
      <section className="py-24 px-6 bg-neutral-950 border-y border-white/[0.07]">
        <div className="max-w-[1100px] mx-auto">
          <div className="text-[1.15rem] font-bold uppercase tracking-[4px] text-[var(--btb-red)] mb-4">Teams</div>
                ...
                <div key={team.teamName} className="group rounded-xl border border-white/[0.07] bg-white/[0.02] p-8 hover:border-white/[0.15] transition-all duration-300">
                  <div className="flex items-start justify-between mb-8">
                    <div>
                      ...
                      <div className="text-[1.2rem] font-bold uppercase tracking-[2px] text-white/25 mt-1">Class of {team.gradYear}</div>
                    </div>
                  </div>
                  ...
                  {tournaments && (
                    <div className="space-y-6 mb-8">
                      {tournaments.summer && (
                        <div>
                          <div className="text-[1.08rem] font-black uppercase tracking-[2px] text-white/45 mb-3 flex items-center gap-2">
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            {tournaments.summer.map((t, i) => (
                              <div key={i} className="bg-white/[0.03] border border-white/5 p-3 rounded-lg">
                                <div className="text-[1.25rem] font-bold text-white/70 uppercase leading-tight mb-1">{t.name}</div>
                                <div className="text-[1.08rem] font-mono text-[var(--btb-red)]">{t.date}</div>
                              </div>
                            ))}
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            {tournaments.fall.map((t, i) => (
                              <div key={i} className="bg-white/[0.03] border border-white/5 p-3 rounded-lg">
                                <div className="text-[1.25rem] font-bold text-white/70 uppercase leading-tight mb-1">{t.name}</div>
                                <div className="text-[1.08rem] font-mono text-white/85">{t.date}</div>
                              </div>
                            ))}
                          </div>
                        </div>
                  ...
                  <div className="flex items-center gap-8 pt-6 border-t border-white/[0.06]">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[1.25rem] font-bold uppercase tracking-[1px] text-white/70">{team.coachCount} Pro Coaches</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Video size={12} className="text-[var(--btb-red)]" />
                      <span className="text-[1.25rem] font-bold uppercase tracking-[1px] text-white/70">Film Study Hub</span>
                    </div>
                  </div>
                </div>
              )
      ...
      <section className="py-24 px-6 border-b border-white/[0.07]">
        <div className="max-w-[900px] mx-auto">
          <div className="text-[1.15rem] font-bold uppercase tracking-[4px] text-[var(--btb-red)] mb-4">Season Info</div>
          <h2 className="font-display text-[clamp(2rem,4vw,3rem)] uppercase tracking-wide leading-[0.92] mb-14">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="rounded-xl border border-white/[0.07] bg-white/[0.02] p-7 hover:border-white/[0.12] transition-colors">
              ...
              <p className="text-[1.05rem] text-white/85 leading-relaxed">Season dates and practice schedules will be posted once registration opens. Check back for updates.</p>
            </div>
            <div className="rounded-xl border border-white/[0.07] bg-white/[0.02] p-7 hover:border-white/[0.12] transition-colors">
              <div className="w-10 h-10 rounded-lg bg-[var(--btb-red)]/20 flex items-center justify-center mb-5">
              ...
              <p className="text-[1.05rem] text-white/85 leading-relaxed">Training and home games held at Long Island facilities. Tournament locations vary by event and age group.</p>
            </div>
            <div className="rounded-xl border border-white/[0.07] bg-white/[0.02] p-7 hover:border-white/[0.12] transition-colors">
              <div className="w-10 h-10 rounded-lg bg-[var(--btb-red)]/20 flex items-center justify-center mb-5">
              ...
              <p className="text-[1.05rem] text-white/85 leading-relaxed">Travel teams require full-season commitment including practices, film sessions, and tournament weekends.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-neutral-950 border-b border-white/[0.07]">
        <div className="max-w-[900px] mx-auto">
          <div className="text-[1.15rem] font-bold uppercase tracking-[4px] text-[var(--btb-red)] mb-4">Where We Compete</div>
          <h2 className="font-display text-[clamp(2rem,4vw,3rem)] uppercase tracking-wide leading-[0.92] mb-14">
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-10">
            <div className="rounded-xl border border-[var(--btb-red)]/25 bg-[var(--btb-red)]/[0.04] p-7">
              <div className="text-[1.1rem] font-bold uppercase tracking-[2px] text-[var(--btb-red)] mb-3">Elite Circuit</div>
              <h3 className="font-display text-[1.4rem] uppercase tracking-wide mb-3">Top National Tournaments</h3>
              <p className="text-[1.1rem] text-white/70 leading-[1.85]">
            ...
            <div className="rounded-xl border border-white/[0.07] bg-white/[0.02] p-7">
              <div className="text-[1.1rem] font-bold uppercase tracking-[2px] text-white/78 mb-3">Regional Play</div>
          ...
          <div className="relative rounded-2xl border border-white/[0.07] overflow-hidden">
            ...
            <div className="relative p-8 md:p-10">
              <p className="text-[1.15rem] text-white/45 leading-[1.85]">

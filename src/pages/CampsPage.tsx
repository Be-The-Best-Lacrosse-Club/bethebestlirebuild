    ...
    <div className="min-h-screen bg-black text-white" style={{ fontFamily: "'Montserrat', sans-serif" }}>
      ...
      <section className="relative px-4 pb-16 pt-24 overflow-hidden md:px-6 md:pb-20">
        ...
        <div className="relative z-10 max-w-[1040px] mx-auto pt-10 md:pt-14">
          <div className="text-[0.8rem] font-black uppercase tracking-[3px] text-[var(--btb-red)] mb-4 md:text-base">
          ...
          <p className="text-base text-white/70 max-w-[620px] leading-[1.75] mb-8 md:text-[1.16rem]">
            ...
            <div role="tablist" aria-label="BTB summer camp options" className="grid grid-cols-1 gap-2 sm:grid-cols-3">
              {CAMPS.map((camp) => {
                ...
                return (
                  ...
                  >
                    <span className="block font-display text-xl uppercase tracking-wide leading-none">
                      {camp.name}
                    </span>
                    <span
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-[auto_1fr_auto] gap-6 md:gap-10 items-start">
                  <div className="flex md:flex-col gap-4 md:gap-3 items-start">
                    ...
                    <span
                      className={`md:hidden text-base font-bold uppercase tracking-[1.5px] px-2.5 py-1 rounded-full self-center ${
                        i === 0
                  ...
                  <div>
                    <div className="hidden md:flex items-center gap-3 mb-3">
                      <span
                        className={`text-base font-bold uppercase tracking-[2px] px-2.5 py-1 rounded-full ${
                          i === 0
                            ? "bg-[var(--btb-red)]/20 text-[var(--btb-red)]"
                    ...
                    <div className="text-base text-white/35 mb-5">{c.forWho}</div>
                    <p className="text-lg text-white/45 leading-relaxed mb-6 max-w-[560px]">
                      {c.description}
                    </p>
                    <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      {c.bullets.map((b) => (
                        <li
                          key={b}
                          className="flex items-start gap-2 text-base text-white/45 leading-relaxed"
                        >
                  ...
                  <div className="md:text-right md:min-w-[200px]">
                    <div className="flex md:flex-col items-baseline md:items-end gap-2 md:gap-1">
                      ...
                      />
                      <div className="font-display text-lg uppercase tracking-wide text-white leading-tight">
                        {c.dates}
                      </div>
                    </div>
                    <div className="text-lg font-bold uppercase tracking-[1.5px] text-white/85 mt-2">
                      {c.range}
                    </div>
                    <div className="flex md:justify-end items-center gap-1.5 mt-3 text-base text-white/55">
                      <Clock size={12} className={i === 0 ? "text-[var(--btb-red)]" : "text-white/70"} />
                      {c.time}
                    </div>
                    <div className="flex md:justify-end items-center gap-1.5 mt-1.5 text-base text-white/55">
                      <MapPin size={12} className={i === 0 ? "text-[var(--btb-red)]" : "text-white/70"} />
                      {c.location}
                    </div>
                    <a
                      href={c.registerUrl}
                      className={`mt-5 block text-center py-3 px-6 font-black text-base uppercase tracking-[2px] transition-all ${
                        i === 0
      ...
      <section id="camp-values" className="py-24 px-6 bg-black border-b border-white/[0.07]">
        <div className="max-w-[1100px] mx-auto">
          ...
          <p className="text-lg text-white/45 mb-14 max-w-[650px] leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-20">
            {CORE_VALUES.map((item) => (
              ...
              >
                ...
                <p className="text-base text-white/50 leading-relaxed">{item.detail}</p>
              </div>
            ))}
          </div>
            ...
            <div className="space-y-3">
              {POSITION_TRACKS.map((track) => (
                ...
                >
                  ...
                  <p className="text-base text-white/55 leading-relaxed">{track.detail}</p>
                </div>
              ))}
            ...
            {[
              ...
              >
                <div className="flex items-start justify-between mb-5">
                  ...
                  <span className="text-base font-bold uppercase tracking-[1.5px] px-2.5 py-1 rounded-full bg-white/[0.05] text-white/25">
                    {b.stat}
                  </span>
                </div>

      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="mb-12 border-b border-white/5 pb-12">
          <div className="flex items-center justify-between gap-4 mb-8">
            <div className="flex items-center gap-3 text-[var(--btb-red)] font-mono text-lg tracking-[5px]">
              <Shield size={14} />
            ...
            <div className="flex items-center gap-4">
               <div className="hidden sm:flex items-center gap-2 px-3 py-1 bg-emerald-500/10 border border-emerald-500/20 rounded-full">
                  ...
                  <span className="text-base font-black uppercase tracking-[1px] text-emerald-500/80">Systems_Online</span>
               </div>
               <button 
                onClick={handleLogout}
                className="text-lg font-black uppercase tracking-[2px] text-white/85 hover:text-white transition-colors"
               >
                 Logout
               </button>
            </div>
          ...
          <div className="grid lg:grid-cols-[1fr_auto] items-end gap-8">
            ...
            <div className="flex gap-4">
              <div className="p-6 rounded-2xl bg-white/[0.02] border border-white/5 text-center min-w-[140px]">
                 ...
                 <div className="text-base font-black text-white/45 uppercase tracking-[1px]">Day Streak</div>
              </div>
              <div className="p-6 rounded-2xl bg-white/[0.02] border border-white/5 text-center min-w-[140px]">
                 <div className="text-3xl font-display text-white mb-1">68%</div>
                 <div className="text-base font-black text-white/45 uppercase tracking-[1px]">Completion</div>
              </div>
            </div>
          </div>
        </div>
        ...
        {(scheduleLoading || hasSchedule || scheduleError) && (
          <section className="mb-12">
            <div className="flex items-end justify-between mb-6">
              <div>
                <div className="flex items-center gap-3 text-[var(--btb-red)] font-mono text-base tracking-[4px] mb-2">
                  <Calendar size={12} />
                  UPCOMING_SCHEDULE
                </div>
            ...
            {scheduleLoading ? (
              <div className="flex items-center gap-3 text-white/70 text-base py-8">
                <Loader2 size={16} className="animate-spin" />
                Loading schedule…
              </div>
            ) : scheduleError ? (
              <div className="text-white/70 text-base py-8">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-center min-w-[60px] shrink-0">
                        <div className="text-base font-black uppercase tracking-[1.5px] text-white/85">{fmt.day}</div>
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          <span className={`text-base font-black uppercase tracking-[2px] px-2 py-0.5 rounded ${
                          ...
                          {evt.isCanceled && (
                            <span className="text-base font-black uppercase tracking-[2px] text-amber-500/80">CANCELLED</span>
                          )}
                        </div>
                        ...
                        <div className="flex items-center gap-4 text-base text-white/70 mt-1">
          ...
          {familyLinks.map((link, i) => {
            ...
            const Content = (
              <div className={`group relative p-8 rounded-2xl border transition-all duration-300 h-full overflow-hidden ${
                ...
                <p className="text-white/70 text-base leading-relaxed mb-8 group-hover:text-white/85 transition-colors relative z-10">
                  {link.desc}
                </p>

                <div className={`flex items-center gap-2 text-lg font-black uppercase tracking-[2px] transition-all relative z-10 ${
        ...
        <div className="mt-16 p-10 rounded-2xl bg-neutral-900 border border-white/5 flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            ...
            <p className="text-white/85 text-xl uppercase tracking-[2px] font-bold">Contact our administrative team for assistance.</p>
          </div>
          <button 
            onClick={() => navigate("/interest")}
            className="px-10 py-4 bg-white/5 border border-white/10 text-white text-base font-black uppercase tracking-[2px] rounded-xl hover:bg-white hover:text-black transition-all"
          >
            Submit Ticket
          </button>
        </div>

    ...
    <div className="min-h-screen bg-black text-white" style={{ fontFamily: "'Montserrat', sans-serif" }}>
      ...
      <section className="pt-40 pb-24 px-6 border-b border-white/[0.07]">
        <div className="max-w-[900px] mx-auto">
          <div className="text-base font-bold uppercase tracking-[4px] text-[var(--btb-red)] mb-6">Players Hub</div>
          ...
          <p className="text-base text-white/85 max-w-[520px] leading-[1.9]">
      ...
      <section className="py-24 px-6 border-b border-white/[0.07]">
        <div className="max-w-[900px] mx-auto">
          <div className="text-base font-bold uppercase tracking-[4px] text-[var(--btb-red)] mb-4">Film Study</div>
          ...
          <div className="space-y-3">
            {filmProcess.map((f) => (
              <div key={f.step} className="flex gap-6 items-start p-6 rounded-xl border border-white/[0.07] bg-white/[0.02] hover:border-white/[0.12] transition-colors">
                ...
                <div>
                  <div className="font-display text-base uppercase tracking-wide text-white mb-1">{f.title}</div>
                  <p className="text-base text-white/85 leading-relaxed">{f.text}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-24 px-6 bg-neutral-950 border-b border-white/[0.07]">
        <div className="max-w-[900px] mx-auto">
          <div className="text-base font-bold uppercase tracking-[4px] text-[var(--btb-red)] mb-4">Development Cycle</div>
            ...
            {phases.map((p, i) => (
              <div key={p.num} className={`p-7 rounded-xl border transition-colors ${
                ...
                <p className="text-base text-white/90 mb-3">
                  <span className="text-white/85 uppercase text-base tracking-[1px] mr-2">Focus</span>
                  {p.focus}
                </p>
                <p className="text-base text-white/85 leading-relaxed">{p.detail}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-[900px] mx-auto">
          <div className="text-base font-bold uppercase tracking-[4px] text-[var(--btb-red)] mb-4">College Track</div>
          <h2 className="font-display text-[clamp(2rem,4vw,3rem)] uppercase tracking-wide leading-[0.92] mb-14">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-14">
            {recruitingTools.map((t) => (
              <div key={t.title} className="p-7 rounded-xl border border-white/[0.07] bg-white/[0.02] flex gap-5 hover:border-white/[0.12] transition-colors">
                ...
                <div>
                  <h4 className="font-display text-base uppercase tracking-wide text-white mb-2">{t.title}</h4>
                  <p className="text-base text-white/85 leading-relaxed">{t.text}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="relative border border-[var(--btb-red)]/25 rounded-2xl px-10 py-12 text-center overflow-hidden">
            ...
            <div className="relative">
              ...
              <a href="#" className="inline-flex items-center gap-2 px-8 py-4 bg-[var(--btb-red)] text-white text-base font-bold uppercase tracking-[2px] rounded hover:bg-[var(--btb-red-dark)] transition-all duration-200">

    ...
    <section className="bg-black py-16 md:py-32 px-4 md:px-6 relative overflow-hidden border-t border-white/5" id="results">
      ...
      <div className="max-w-[1100px] mx-auto relative z-10">
        <div className="flex flex-col items-center md:items-end md:flex-row md:justify-between mb-12 md:mb-24 gap-6 md:gap-8 pb-8 md:pb-12 border-b border-white/10 text-center md:text-left">
          ...
          <p className="text-white/90 text-base leading-relaxed max-w-[380px] border-l border-white/10 pl-8">
            Authentic feedback from the families who live the BTB Standard every weekend. Real development. Real results.
          </p>
        </div>

        {/* Featured Quote */}
        <div className="relative bg-[#D22630] p-8 md:p-12 lg:p-20 mb-0.5 overflow-hidden group">
          ...
          <div className="relative z-10">
            ...
            <p className="font-display text-[clamp(1.2rem,4vw,2.5rem)] uppercase leading-[1.1] text-white mb-8 md:mb-12 max-w-[800px]">
              "{parentTestimonials[0].quote}"
            </p>
            <div className="flex items-center gap-4">
              <div className="w-12 h-px bg-white/30" />
              <div className="text-base font-black uppercase tracking-[3px] text-black/60">{parentTestimonials[0].role}</div>
            </div>
          </div>
        </div>
        ...
        <div ref={gridRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0.5 bg-white/10 border-x border-b border-white/10">
          {[...testimonials, ...parentTestimonials.slice(1)].map((t, i) => (
            ...
            >
              ...
              <p className="text-base text-white/90 leading-relaxed mb-10 italic group-hover:text-white/90 transition-colors">
                "{t.quote}"
              </p>
              <div className="pt-6 border-t border-white/5">
                ...
                <div className="text-base font-mono text-white/90 uppercase tracking-[1px] mt-1">
                  Verified_Feedback
                </div>
              </div>
            </div>

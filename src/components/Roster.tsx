  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center py-24 text-white/35 bg-black">
        ...
        <p className="text-base font-mono uppercase tracking-[4px]">Initializing_Roster_Feed...</p>
      </div>
    );
  }
    ...
    <section className="py-24 px-6 bg-black relative overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-[1100px] mx-auto relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 pb-8 border-b border-white/10 gap-6">
          <div>
            <div className="flex items-center gap-3 text-[var(--btb-red)] font-mono text-lg tracking-[4px] mb-4">
          ...
          <div className="flex items-center gap-4">
            <div className="text-right hidden md:block">
              <div className="text-base font-black text-white/85 uppercase tracking-[2px]">Verified Athletes</div>
            ...
            >
              <div className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <div className="text-base font-mono text-white/45 uppercase tracking-[1px]">

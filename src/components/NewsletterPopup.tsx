      ...
      <div className="relative w-full max-w-[480px] bg-black border border-white/10 rounded-2xl p-8 sm:p-10 shadow-2xl">
        ...
        {submitted ? (
          <div className="text-center py-6">
            ...
            <p className="text-white/78 text-lg leading-relaxed mb-8">
              Welcome to the BTB list. Look out for news, events, and updates from the program.
            </p>
            <button
              type="button"
              onClick={() => setOpen(false)}
              className="w-full py-3.5 bg-[var(--btb-red)] text-white text-xl font-bold uppercase tracking-[2px] rounded hover:bg-[var(--btb-red-dark)] transition-all"
            >
              Continue
            </button>
          </div>
          ...
          <>
            <div className="flex items-center gap-2 text-[var(--btb-red)] font-mono text-base tracking-[5px] mb-5">
              <Mail size={12} />
              BTB_NEWSLETTER
            </div>
            <h2
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full h-12 px-4 bg-white/[0.04] border border-white/10 rounded-lg text-white text-lg placeholder:text-white/25 focus:outline-none focus:border-[var(--btb-red)]/50 transition-all"
                />
              </div>
              <div>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className={`flex-1 h-12 rounded-lg text-base font-bold uppercase tracking-[1.5px] transition-all border ${gender === "Boys" ? "bg-[var(--btb-red)] border-[var(--btb-red)] text-white" : "bg-white/[0.04] border-white/10 text-white/70 hover:border-white/30"}`}
                  >
                    Boys
                  </button>
                  <button
                    ...
                    className={`flex-1 h-12 rounded-lg text-base font-bold uppercase tracking-[1.5px] transition-all border ${gender === "Girls" ? "bg-[var(--btb-red)] border-[var(--btb-red)] text-white" : "bg-white/[0.04] border-white/10 text-white/70 hover:border-white/30"}`}
                  >
                    Girls
                  </button>
                </div>
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full py-3.5 bg-[var(--btb-red)] text-white text-xl font-bold uppercase tracking-[2px] rounded hover:bg-[var(--btb-red-dark)] transition-all disabled:opacity-60 disabled:cursor-not-allowed"
              >
                {submitting ? "Joining…" : "Join The List"}
              </button>
              <p className="text-xl text-white/85 text-center pt-1">

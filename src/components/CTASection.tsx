    ...
    <section className="bg-white py-14 md:py-28 px-4 md:px-6 relative overflow-hidden" id="apply">
      <div className="max-w-[900px] mx-auto">
        <div className="flex items-center gap-3 justify-center mb-8">
          <span className="text-base font-bold tracking-[3px] uppercase text-black/25">09</span>
          <div className="h-px w-8 bg-black/10" />
          <span className="text-base font-bold uppercase tracking-[4px] text-[var(--btb-red)]">Ready to Apply</span>
        </div>
        ...
        <div ref={cardRef as React.RefObject<HTMLDivElement>} className="bg-black rounded-2xl overflow-hidden">
          ...
          <div className="px-6 md:px-10 lg:px-16 py-10 md:py-16 text-center">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[var(--btb-red)]/10 border border-[var(--btb-red)]/20 rounded-full mb-8">
              ...
              <span className="text-base font-black uppercase tracking-[3px] text-[var(--btb-red)]">
            ...
            <p className="text-base text-white/90 max-w-[460px] mx-auto leading-[1.85] mb-10">
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-12">
              {["Serious about development", "Coachable & accountable", "Ready to study film", "Committed to the process"].map((item) => (
                <div key={item} className="flex items-center gap-2 px-4 py-2 border border-white/10 rounded-full">
                  ...
                  <span className="text-base font-semibold uppercase tracking-[1px] text-white/90">{item}</span>
                </div>
              ))}
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                ...
                className="inline-flex items-center justify-center gap-2.5 px-9 py-4 bg-[var(--btb-red)] text-white text-base font-bold uppercase tracking-[2px] rounded hover:bg-[var(--btb-red-dark)] hover:-translate-y-0.5 btn-glow transition-all duration-200"
              >
                Request Evaluation <ArrowRight size={13} />
              </button>
              <button
                onClick={() => navigate("/contact")}
                className="inline-flex items-center justify-center gap-2.5 px-9 py-4 border border-white/15 text-white/90 text-base font-bold uppercase tracking-[2px] rounded hover:border-white/30 hover:text-white transition-all duration-200"
              >
        ...
        <p className="text-center text-base text-white/90 mt-8">

        ...
        <div className="min-h-screen bg-black flex items-center justify-center px-6" style={{ fontFamily: "'Montserrat', sans-serif" }}>
          <div className="text-center max-w-md">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-[var(--btb-red)] text-white text-base font-bold uppercase tracking-[2px] rounded-lg hover:bg-[var(--btb-red-dark)] transition-colors"
            >
              <ArrowLeft size={14} />
              Go to My Hub
            </a>

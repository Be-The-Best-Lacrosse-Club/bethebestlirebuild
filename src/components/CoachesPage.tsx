    ...
    <div className="min-h-screen bg-black text-white" style={{ fontFamily: "'Montserrat', sans-serif" }}>
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-black/90 backdrop-blur-md border-b border-white/[0.06]">
        <div className="max-w-[1100px] mx-auto px-6 h-16 flex items-center justify-between">
          <button onClick={onBack} className="flex items-center gap-2 text-white/85 hover:text-white transition-colors text-base font-semibold uppercase tracking-[1.5px]">
          ...
          <a href="#" className="px-5 py-2 bg-[var(--btb-red)] text-white text-base font-bold uppercase tracking-[1.5px] rounded hover:bg-[var(--btb-red-dark)] transition-colors">
            Apply Now
          </a>
        </div>
      </div>
      ...
      <section className="pt-40 pb-24 px-6 border-b border-white/[0.07]">
        <div className="max-w-[900px] mx-auto">
          <div className="text-base font-bold uppercase tracking-[4px] text-[var(--btb-red)] mb-6">Coaches Hub</div>
          ...
          <p className="text-base text-white/85 max-w-[560px] leading-[1.9]">
      ...
      <section className="py-24 px-6 border-b border-white/[0.07]">
        <div className="max-w-[900px] mx-auto">
          <div className="text-base font-bold uppercase tracking-[4px] text-[var(--btb-red)] mb-4">Coaching Philosophy</div>
          ...
          <div className="space-y-0 border-t border-white/[0.07]">
            {principles.map((p) => (
              <div key={p.num} className="flex items-start gap-8 py-8 border-b border-white/[0.07] group">
                <div className="font-display text-base text-white/15 group-hover:text-[var(--btb-red)] transition-colors shrink-0 pt-0.5 w-6">{p.num}</div>
                <div>
                  <h4 className="font-display text-lg uppercase tracking-wide text-white group-hover:text-[var(--btb-red)] transition-colors mb-2">{p.title}</h4>
                  <p className="text-base text-white/85 leading-relaxed">{p.text}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-24 px-6 bg-neutral-950 border-b border-white/[0.07]">
        <div className="max-w-[900px] mx-auto">
          <div className="text-base font-bold uppercase tracking-[4px] text-[var(--btb-red)] mb-4">Practice Structure</div>
          <h2 className="font-display text-[clamp(2rem,4vw,3rem)] uppercase tracking-wide leading-[0.92] mb-4">
            How a BTB<br />Practice Runs
          </h2>
          <p className="text-base text-white/85 mb-14 max-w-[420px] leading-relaxed">
          ...
          <div className="space-y-3">
            {sessionStructure.map((s) => (
              <div key={s.segment} className="flex gap-6 items-start p-6 rounded-xl border border-white/[0.07] bg-white/[0.02] hover:border-white/[0.12] transition-colors">
                <div className="shrink-0 text-base font-bold text-[var(--btb-red)] uppercase tracking-[1px] w-20 pt-0.5">{s.time}</div>
                <div className="w-px self-stretch bg-white/[0.08]" />
                <div>
                  <div className="font-display text-base uppercase tracking-wide text-white mb-1">{s.segment}</div>
                  <p className="text-base text-white/85 leading-relaxed">{s.detail}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-24 px-6 border-b border-white/[0.07]">
        <div className="max-w-[900px] mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-14">
            <div>
              <div className="text-base font-bold uppercase tracking-[4px] text-[var(--btb-red)] mb-4">50+ Drill Playbook</div>
            ...
            <p className="text-base text-white/85 max-w-[280px] leading-relaxed md:text-right">
            ...
            {drillCategories.map((d, i) => (
              <div key={d.category} className={`p-6 rounded-xl border transition-colors ${
                ...
                <div className="flex items-start justify-between mb-2">
                  <h4 className="font-display text-base uppercase tracking-wide text-white">{d.category}</h4>
                  <span className="font-display text-[var(--btb-red)] text-2xl leading-none">{d.count}</span>
                </div>
                <p className="text-base text-white/85 leading-relaxed">{d.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 px-6 bg-neutral-950">
        <div className="max-w-[900px] mx-auto">
          <div className="text-base font-bold uppercase tracking-[4px] text-[var(--btb-red)] mb-4">Requirements</div>
          <h2 className="font-display text-[clamp(2rem,4vw,3rem)] uppercase tracking-wide leading-[0.92] mb-14">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {certifications.map((c) => (
              <div key={c.title} className="p-7 rounded-xl border border-white/[0.07] bg-white/[0.02] flex gap-5 hover:border-white/[0.12] transition-colors">
                ...
                <div>
                  <h4 className="font-display text-base uppercase tracking-wide text-white mb-2">{c.title}</h4>
                  <p className="text-base text-white/85 leading-relaxed">{c.text}</p>
                </div>
              </div>
            ))}
          </div>

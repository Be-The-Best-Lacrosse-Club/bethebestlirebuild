    ...
    <div className="min-h-screen bg-black text-white" style={{ fontFamily: "'Montserrat', sans-serif" }}>
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-black/90 backdrop-blur-md border-b border-white/[0.06]">
        <div className="max-w-[1100px] mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <a href="#apply-boys" className="px-5 py-2 bg-[var(--btb-red)] text-white text-base font-bold uppercase tracking-[1.5px] rounded hover:bg-[var(--btb-red-dark)] transition-colors">
            Apply Now
          </a>
        </div>
      </div>
      ...
      <section className="relative pt-40 pb-28 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[900px] mx-auto">
          <div className="text-lg font-bold uppercase tracking-[4px] text-[var(--btb-red)] mb-6">Boys Program</div>
          ...
          <div className="flex gap-3 flex-wrap">
            <a href="#apply-boys" className="inline-flex items-center gap-2 px-8 py-4 bg-[var(--btb-red)] text-white text-base font-bold uppercase tracking-[2px] rounded hover:bg-[var(--btb-red-dark)] hover:-translate-y-0.5 hover:shadow-[0_12px_30px_rgba(210,38,48,0.4)] transition-all duration-200">

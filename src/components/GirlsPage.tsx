    ...
    <div className="min-h-screen bg-black text-white" style={{ fontFamily: "'Montserrat', sans-serif" }}>
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-black/90 backdrop-blur-md border-b border-white/[0.06]">
        <div className="max-w-[1100px] mx-auto px-6 h-16 flex items-center justify-between">
          <button onClick={onBack} className="flex items-center gap-2 text-white/70 hover:text-white transition-colors text-base font-semibold uppercase tracking-[1.5px]">
          ...
          <a href="#apply-girls" className="px-5 py-2 bg-[var(--btb-red)] text-white text-base font-bold uppercase tracking-[1.5px] rounded hover:bg-[var(--btb-red-dark)] transition-colors">
            Apply Now
          </a>
        </div>
      </div>
      ...
      <section className="relative pt-40 pb-28 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[900px] mx-auto">
          <div className="text-lg font-bold uppercase tracking-[4px] text-[var(--btb-red)] mb-6">Girls Program</div>
          ...
          <div className="flex gap-3 flex-wrap">
            <a href="#apply-girls" className="inline-flex items-center gap-2 px-8 py-4 bg-[var(--btb-red)] text-white text-base font-bold uppercase tracking-[2px] rounded hover:bg-[var(--btb-red-dark)] hover:-translate-y-0.5 hover:shadow-[0_12px_30px_rgba(210,38,48,0.4)] transition-all duration-200">
      ...
      <section className="py-14 px-6 bg-neutral-950 border-y border-white/[0.07]">
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-6">
            {teams.map((t) => (
              <div key={t} className="px-4 py-2 border border-white/[0.08] rounded-full text-base font-bold uppercase tracking-[1.5px] text-white/70">
                Class of {t}
              </div>
            ))}
          </div>
              ...
              <div key={b.title} className={`group rounded-2xl border p-7 transition-all duration-300 ${
                ...
                <div className="flex items-start justify-between mb-5">
                  <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                    ...
                    <b.icon size={18} strokeWidth={1.5} className={i === 2 ? "text-[var(--btb-red)]" : "text-white/70"} />
                  </div>
      ...
      <section className="py-24 px-6 border-b border-white/[0.07]">
        <div className="max-w-[900px] mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-14">
            <div>
              <div className="text-lg font-bold uppercase tracking-[4px] text-[var(--btb-red)] mb-4">Development Model</div>
              <h2 className="font-display text-[clamp(2rem,4vw,3rem)] uppercase tracking-wide leading-[0.92]">
                16-Week Cycle.<br />Four Phases.
              </h2>
            </div>
            <p className="text-lg text-white/35 max-w-[280px] leading-relaxed md:text-right">
            ...
            {phases.map((p, i) => (
              <div key={p.num} className={`relative rounded-xl border p-7 overflow-hidden group transition-all duration-300 ${
                ...
                <ul className="space-y-2">
                  {p.items.map((item) => (
                    <li key={item} className="flex items-start gap-2.5 text-base text-white/35">
            ...
            <div className="relative">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-white/35 text-base">{testimonials[1].role}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative border border-[var(--btb-red)]/25 rounded-2xl px-10 py-14 overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="#" className="inline-flex items-center justify-center gap-2 px-9 py-4 bg-[var(--btb-red)] text-white text-base font-bold uppercase tracking-[2px] rounded hover:bg-[var(--btb-red-dark)] transition-all duration-200">
                  Apply for 2026 <ArrowRight size={13} />
                </a>

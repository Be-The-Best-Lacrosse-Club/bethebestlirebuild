    ...
    <div className="min-h-screen bg-black text-white" style={{ fontFamily: "'Montserrat', sans-serif" }}>
      ...
      <div className="fixed top-0 inset-x-0 z-50 bg-black/90 backdrop-blur-md border-b border-white/[0.07]">
        <div className="max-w-[1200px] mx-auto px-6 py-3 flex items-center justify-between gap-4">
          <button
            onClick={onBack}
            className="flex items-center gap-2 text-white/85 hover:text-white transition-colors text-base font-semibold uppercase tracking-[1.5px] flex-shrink-0"
          >
            <ArrowLeft size={14} /> Back
          </button>

          <div className="flex-1 min-w-0 text-center">
            <span className="font-display text-xl uppercase tracking-wide truncate block">
              {course.title}
            </span>
          </div>
          ...
          <button
            ...
            className="md:hidden flex items-center gap-1.5 text-white/85 hover:text-white text-xl font-bold uppercase tracking-[1.5px] flex-shrink-0"
          >
      ...
      <div className="flex max-w-[1200px] mx-auto pt-[60px]">
        ...
        >
          <div className="p-5">
            <div className="text-base font-bold uppercase tracking-[3px] text-white/45 mb-1">Progress</div>
            <div className="text-lg text-white/78 mb-4">
            ...
            <div className="space-y-1">
              {course.steps.map((s, i) => {
                ...
                return (
                  ...
                  >
                    <div className={`w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 text-base font-bold ${
                      done
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="flex items-center gap-1.5 mt-0.5">
                        ...
                        <span className="text-base uppercase tracking-[1px] text-white/15">{s.type}</span>
                      </div>
                    </div>
                  </button>
                )
        ...
        <main className="flex-1 min-w-0 px-6 md:px-12 py-10">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-base font-bold uppercase tracking-[3px] text-white/45">
          ...
          {isStepComplete && currentStepIndex < course.steps.length - 1 && (
            <div className="mt-8 pt-6 border-t border-white/[0.07]">
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 bg-[var(--btb-red)] text-white text-base font-bold uppercase tracking-[1.5px] rounded-lg hover:bg-[var(--btb-red)]/80 transition-colors"
              >
          ...
          {pct === 100 && (
            <div className="mt-10 p-6 rounded-xl border border-[var(--btb-red)]/30 bg-[var(--btb-red)]/5 text-center">
              ...
              <button
                onClick={onBack}
                className="mt-5 px-6 py-2.5 border border-white/15 text-white/78 text-xl font-bold uppercase tracking-[1.5px] rounded-lg hover:border-white/40 hover:text-white transition-all"
              >
                Back to Dashboard
              </button>
            </div>
    ...
    <div>
      ...
      <div className="aspect-video bg-neutral-900 rounded-xl border border-white/[0.07] flex items-center justify-center mb-6">
        <div className="text-center">
          ...
          <p className="text-base text-white/45 uppercase tracking-[1.5px] font-semibold">Film Coming Soon</p>
          {step.content.duration && (
            <p className="text-lg text-white/35 mt-1">{step.content.duration} min</p>
          )}
        </div>
      </div>
      ...
      {isComplete && (
        <div className="flex items-center gap-2 text-[var(--btb-red)] text-base font-bold uppercase tracking-[1.5px]">
    ...
    <div>
      ...
      <div className="space-y-3 mb-8">
        {step.content.options?.map((opt, i) => {
          ...
          return (
            ...
            >
              <div className={`w-7 h-7 rounded-full border flex items-center justify-center flex-shrink-0 text-lg font-bold ${
                selectedOption === i
      ...
      {!answerSubmitted && !isComplete && (
        <button
          ...
          className={`px-6 py-3 text-base font-bold uppercase tracking-[1.5px] rounded-lg transition-all duration-200 ${
            selectedOption !== null
      ...
      <div className="p-6 rounded-xl border border-white/[0.07] bg-white/[0.02] mb-8">
        {step.content.duration && (
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-lg font-bold uppercase tracking-[2px] text-[var(--btb-red)]">

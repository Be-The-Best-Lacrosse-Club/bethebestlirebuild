...
const CAMP_DATE = new Date("2026-08-19T12:00:00-04:00");
const POST_RATE = { limit: 8, windowMs: 60_000 };

const POSITIONS = new Set([
  "Attack", "Midfield", "Defense", "Goalie", "Draw Specialist", "Unsure",
]);
...
export default async (req, context) => {
  ...
  try {
    ...
    try {
      ...
      console.warn("girls-mini-camp registration status update failed:", error);
    }
